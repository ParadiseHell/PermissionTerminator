 ...
 */
package org.paradisehell.middleware.permission
...
import org.paradisehell.middleware.permission.behavior.DenialRequest
import org.paradisehell.middleware.permission.behavior.NeverAskRequest
import org.paradisehell.middleware.permission.processor.PermissionProcessor
...
internal class PermissionFragment : Fragment() {
     ...
     */
    private val processors = LinkedList<PermissionProcessor<*>>()

    /**
     * A map of [ActivityResultLauncher] which can get easily by a [PermissionProcessor]
     */
    private val processorLauncherMap =
        mutableMapOf<PermissionProcessor<*>, ActivityResultLauncher<out Any>>()
        ...
        run {
            processors.forEach { processor ->
                if (processor.canProcessPermission(permission)) {
                    ...
                    @Suppress("UNCHECKED_CAST")
                    (processor as PermissionProcessor<Any>).requestPermission(
                        requireActivity(),
                        launcher as ActivityResultLauncher<Any>,
                        permission
                    )
                    return@run
                }
